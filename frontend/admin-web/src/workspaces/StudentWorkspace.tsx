...
export function StudentWorkspace({ view, data }: StudentWorkspaceProps) {
        ...
        <div>
          ...
          <div className="student-grid">
            {TILES.map(t => {
              const Icon = t.icon;
              return (
                <button key={t.key} className={`student-tile ${view === t.key ? "active" : ""}`}>
                  <Icon size={22} />
                  <span>{t.label}</span>
                </button>
              );
  ...
  if (view === "My Fees") {
    return (
      <div className="content-grid">
        <div className="metric-grid">
          <div className="metric amber"><div className="metric-icon"><FileText size={22} /></div><div className="metric-body"><strong>UGX 450,000</strong><span>Total Invoiced</span></div></div>
          <div className="metric green"><div className="metric-icon"><FileText size={22} /></div><div className="metric-body"><strong>UGX 130,000</strong><span>Paid</span></div></div>
          <div className="metric red"><div className="metric-icon"><FileText size={22} /></div><div className="metric-body"><strong>UGX 320,000</strong><span>Balance</span></div></div>
